...
def meson_fatal_warnings():
    ...
    def __init__(self, source_dir, build_dir, meson_args=None, editable_verbose=None, **kwargs):
        ...
        mesonpy_project_init(self, source_dir, build_dir, meson_args, editable_verbose, **kwargs)
